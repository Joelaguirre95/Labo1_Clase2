...
int utn_calcularNumeroMinimo(int *pArray,int limite,int *minimo)
{
    int auxMin;
    int i;
    int retorno=-1;
...
int utn_buscarNumeroEnArray(int *pBuffer,int limite,int elementoABuscar)
{
    int retorno = -1;
    int i;
    if(pBuffer!=NULL && limite>0)
